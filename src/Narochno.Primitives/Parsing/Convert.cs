    ...
    where TType : struct
{
    ...
    public static TType? TryParse(string input) =>
        DefaultParserLibrary.Instance.GetParser<TType>().TryParse(input);
    ...
    public static TType Parse(string input) =>
        DefaultParserLibrary.Instance.GetParser<TType>().Parse(input);
    ...
    public static string ToString(TType type) =>
        DefaultParserLibrary.Instance.GetParser<TType>().ToString(type);
}
