...
public static class StringExtensions
{
    ...
    public static TType? TryParse<TType>(this string input)
        where TType : struct => DefaultParserLibrary.Instance.GetParser<TType>().TryParse(input);
    ...
    public static object? TryParse(this string input, Type type) =>
        DefaultParserLibrary.Instance.GetParser(type).TryParse(input);
    ...
    public static TType Parse<TType>(this string input)
        where TType : struct => DefaultParserLibrary.Instance.GetParser<TType>().Parse(input);
    ...
    public static object Parse(this string input, Type type) =>
        DefaultParserLibrary.Instance.GetParser(type).Parse(input);
}
